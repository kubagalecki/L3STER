    ...
    namespace util
    {
        ...
        */
        ...
        public:
            ...
            // Access
            types::val_t* data() { return coefs.data(); }       // access the underlying array
            ...
            // Operators
            Polynomial<N> operator+=(types::val_t _a) { coefs.front() += _a; return *this; }    // increment by cosntant
        ...
        Polynomial<N>::Polynomial(std::initializer_list<types::val_t> init_list)
        {
            ...
            {
                throw (std::length_error("Incorrect number of coefficients for polynomial of specified order. Should be: "
        ...
        Polynomial < N - 1 > Polynomial<N>::polyder()
        {
            ...
            if (N == 1)       return Polynomial<0> {coefs[1]};
        ...
        std::array<std::complex<types::val_t>, N> Polynomial<N>::roots()
        {
            ...
            [](complex_t a, complex_t b) { return std::abs(a) < std::abs(b); });
        ...
        public:
            ...
            // Access
            types::val_t* data() { return &a0; }       // access the underlying coefficient
            ...
            // Operators
            Polynomial<0>   operator+= (types::val_t _a) { a0 += _a; return *this; }
            Polynomial<0>   operator*= (types::val_t _a) { a0 *= _a; return *this; }

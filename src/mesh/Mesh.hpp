#ifndef L3STER_INCGUARD_MESH_HPP
#define L3STER_INCGUARD_MESH_HPP
...
public:
    ...
    using variant_t     = parametrize_over_dims_t< std::variant, node_vector_t >;
...
#endif // L3STER_INCGUARD_MESH_HPP

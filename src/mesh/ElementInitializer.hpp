...
namespace lstr {
    namespace mesh {
        ...
        bool ElementInitializerMaster::init_status = initializeElementInitializerMaster();
        ...
        void initializeElement(T) {
            ...
            if (std::none_of(ElementInitializerMaster::initialized_elements.cbegin(),
                             ElementInitializerMaster::initialized_elements.cend(),
                             op)) {
                // Add to list of initialized elements
                ElementInitializerMaster::initialized_elements.emplace_back(T::el_t, T::el_o);

                // Register element vector with appropriate factory
                util::Factory<std::pair<ElementTypes, types::el_o_t>, ElementVectorBase>::registerCreator<
                        ElementVector<T::el_t, T::el_o>>(std::make_pair(T::el_t, T::el_o));

                util::Factory<std::pair<ElementTypes, types::el_o_t>, ElementBase>::registerCreator<
                        Element<T::el_t, T::el_o>>(std::make_pair(T::el_t, T::el_o));

...
using el_ns_t      = uint_fast8_t;  // number of element sides (points/edges/faces) type
using el_locind_t  = uint_fast16_t; // local element index t., #nodes/element must not overflow this
...
using global_dof_t = uint_fast64_t; // global DOF type
} // namespace lstr

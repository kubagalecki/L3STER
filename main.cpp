...
int main()
{
    try
    {
        ...
        auto&& NA =
            lstr::mesh::Element<lstr::mesh::ElementTypes::Quad, 1>::node_array_t{1, 2, 8, 6};
        d.emplaceBack<lstr::mesh::ElementTypes::Quad, 1>(std::move(NA));

        auto&& Q = lstr::quad::QuadratureGenerator<
            lstr::mesh::ElementTypes::Quad>::getQuadrature<lstr::quad::QuadratureTypes::GLeg, 2>();
        ...
        auto ev = lstr::util::Factory<
            std::pair<lstr::mesh::ElementTypes, lstr::types::el_o_t>,
            lstr::mesh::ElementVectorBase>::create(std::make_pair(lstr::mesh::ElementTypes::Quad,
                                                                  1));

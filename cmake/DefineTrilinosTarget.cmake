...
function( define_trilinos_target Verbosity Version )
    ...
    if ( Trilinos_HAS_OPENMP )
        find_package( OpenMP )
        if ( OpenMP_CXX_FOUND )
            target_link_libraries( Trilinos INTERFACE OpenMP::OpenMP_CXX )
        else ()
            message( SEND_ERROR "Trilinos was built with OpenMP, but the current compiler lacks OpenMP support" )
        endif ()
    endif ()

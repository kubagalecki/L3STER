...
function( detect_hwloc Verbosity )
    ...
    find_library( hwloc_LIBRARY_PATH hwloc HINTS ${hwloc_INCLUDE_DIR}/.. PATH_SUFFIXES lib )
    ...
    set_target_properties( hwloc PROPERTIES IMPORTED_LOCATION ${hwloc_LIBRARY_PATH} )
endfunction()

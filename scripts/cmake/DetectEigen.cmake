...
function( detect_eigen Verbosity EigenPath L3STERPath )
    ...
    if ( Eigen3_DIR )
        file( GLOB_RECURSE EigenPath ${Eigen3_DIR}/*signature_of_eigen3_matrix_library )
    endif ()
    if ( EigenPath )
        get_filename_component( EigenPath ${EigenPath} DIRECTORY )
        add_library( L3STER_Eigen INTERFACE )

...
static void diff2DTest(MakeElement&& make_element)
{
    ...
    constexpr auto n_nodes = ElementTraits< eltype >::nodes_per_element;
    ...
    using dirichlet_index     = util::smallest_integral_t< operand_size< params, n_nodes > >;
    ...
    auto y           = evalImpl< params >(local_element, diffusion_kernel_2D, x_bc);
...
static void diff3DTest(MakeElement&& make_element)
{
    ...
    auto y           = evalImpl< params >(local_element, diffusion_kernel_3D, x_bc);
